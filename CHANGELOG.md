...
* **SREAA-368:** upgrade module to v9 (OpenTofu >= 1.12, AzureRM ~> 5.0) d87bdbc

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.12.5 9424fa5
* **deps:** update dependency tflint to v0.64.0 7251c05
* **SREAA-368:** synchronize committed.toml and AGENTS.md from the ci template ce36547
* **v9:** 🐛 synchronize common files and docs faf1172

## 8.1.5 (2026-07-20)

### Bug Fixes

* **tflint:** 🐛 bump Azure rules version, fix signature bug 5bfd28b

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.12.1 9c131f0
* **deps:** update dependency opentofu to v1.12.2 94bc7c3
* **deps:** update dependency opentofu to v1.12.3 e62e9d7
* **deps:** update dependency opentofu to v1.12.4 c05d599
* **deps:** update dependency tflint to v0.63.1 4775102
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.1 3461ab4
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.2 db01ff5

## 8.1.4 (2026-06-02)

### Bug Fixes

* 🐛 default output `resource` now require sensitive with OpenTofu 1.12+ c802cf5

### Miscellaneous Chores

* **deps:** 🔗 update mise conf for OpenTofu cc3b567
* **deps:** update dependency opentofu to v1.11.7 29b80f9
* **deps:** update dependency opentofu to v1.12.0 20f2013
* **deps:** update dependency terraform-docs to v0.23.0 d5f852c
* **deps:** update dependency terraform-docs to v0.24.0 a955d93
* **deps:** update dependency tflint to v0.62.1 634d4b6
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.3.0 5b3242d
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.0 56dbbeb
* **deps:** update tools 6bdf4ba
* **pre-commit:** 🔧 move to prek 2df4003
* **tfdocs:** bump tfdocs to v0.22 🔧 e1d9ae7

## 8.1.3 (2026-03-27)

### Bug Fixes

* **trivy:** 🐛 drop unsafe trivy pre-commit 🔒️ 1b32680

### Code Refactoring

* update module structure and Github actions 👷 2b690a4

### Miscellaneous Chores

* **AI:** 🤖 add AI Agents instructions for Contributing 834bf28
* **deps:** 🔗 bump tflint rules version 47cee39
* **deps:** update dependency trivy to v0.69.2 0aa0287
* **deps:** update dependency trivy to v0.69.3 390988e
* **deps:** update pre-commit hook crate-ci/committed to v1.1.11 d0e81eb
